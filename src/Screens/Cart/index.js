          ...
          <Box p={5} bg="#D3D3D3" m={5} rounded={5}>
              ...
              <VStack w="50%">
                ...
                <HStack mt={2}>
                  <Button
                    ...
                    bg={Color.green}
                    endIcon={
                      <Icon2 name="star" size={10} color={Color.white} />
                    }
                    h={7}>
                    {item.rating.rate}
                  </Button>

                  <Text fontSize="xs" mt={1} color={Color.gray} ml={2}>
                    (13,564)
                  </Text>
                </HStack>
            ...
            <HStack mt={5}>
              <Button
                ...
                startIcon={<Icon name="save" size={20} color={Color.gray} />}
                bg={Color.white}
                w="50%"
                _text={{
                  color: '#898989',
              ...
              <Button
                ...
                startIcon={<Icon3 name="delete" size={20} color={Color.gray} />}
                bg={Color.white}
                w="50%"
                _text={{
                  color: '#898989',
